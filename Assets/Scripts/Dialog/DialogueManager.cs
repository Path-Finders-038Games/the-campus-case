...
namespace Dialog
{
    public class DialogueManager : MonoBehaviour
    {
        ...
        private void FillDialogueList()
        {
            ...
            //Sport cafe
            List<Dialogue> BuddyDialogueSportCafeNL = new();
            ...
            //X1 exit
            List<Dialogue> BuddyDialogueXbuildingExitNL = new();
            ...
            //Sport cafe
            List<Dialogue> BuddyDialogueSportCafeEN = new();
            ...
            //X1 exit
            List<Dialogue> BuddyDialogueXbuildingExitEN = new();
            ...
            //T5 bridge end
            List<Dialogue> BuddyDialogueTbridgeEndEN = new();
